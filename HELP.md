...
* The original package name 'net.javaguides.springboot-rabbitmq-tutorial' is invalid and this project uses 'net.javaguides.springbootrabbitmqtutorial' instead.
